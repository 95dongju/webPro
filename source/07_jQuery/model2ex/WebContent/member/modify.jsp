...
<jsp:include page="../main/header.jsp"></jsp:include>
	<form action="${conPath }/modify.do" id="content_form" method="post" enctype="multipart/form-data">
			<input type="hidden" name="dbMpw" value="${member.mpw }">
			<input type="hidden" name="dbMphoto" value="${member.mphoto }">
		<table>
			<tr>
				<th>아이디</th><td><input type="text" name="mid" id="mid" value="${member.mid }" readonly="readonly"></td><td rowspan="4"><img src="${conPath }/memberPhotoUp/${member.mphoto}"></td>
			</tr>
			<tr>
				<th>현 비밀번호</th><td><input type="password" name="oldMpw" id="oldMpw"></td>
			</tr>
			<tr>
				<th>바꿀 비밀번호</th><td><input type="password" name="mpw" id="mpw"></td>
			</tr>
			<tr>
				<th>이름</th><td><input type="text" name="mname" id="mname" value="${member.mname }"></td>
			</tr>
			<tr>
				<th>메일</th><td colspan="2"><input type="text" name="memail" id="memail" value="${member.memail }"></td>
			</tr>
			<tr>
				<th>사진</th><td colspan="2"><input type="file" name="mphoto" id="mphoto"></td>
			</tr>
			<tr>
				<th>생년월일</th><td colspan="2"><input type="text" name="mbirth" id="datepicker" value="${member.mbirth }"></td>
			</tr>
			<tr>
				<th>주소</th><td colspan="2"><input type="text" name="maddress" id="maddress" value="${member.maddress }"></td>
			</tr>
			<tr>
				<td colspan="3">
					<input type="submit" value="정보수정" class="btn">
					<input type="reset" value="초기화" class="btn">
					<input type="button" value="이전" onclick="history.back()" class="btn">
