...
public class BoardDto {
	...
	private String fip;
	public BoardDto() {}
	public BoardDto(int fid, String mid, String mname, String ftitle, String fcontent, String ffilename, Timestamp frdate, int fhit,
	...
	public String toString() {
		return "BoardDto [fid=" + fid + ", mid=" + mid + ", mname=" + mname + ", ftitle=" + ftitle + ", fcontent=" + fcontent
