...
public class FrontController extends HttpServlet {
	...
	private void actionDo(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		// 무슨 요청이 들어왔는지 판별 (select.do? delete.do? insert.do? update.do?) 하고 해당 요청을 수행 -> view로 forward 함 
		...
		// 들어온 요청에 따라 적절한 일을 하고 뷰로 forward
		String viewPage = null; // 뷰페이지를 저장할 변수
		Service service = null; // InsertService나 SelectService, DeleteService, UpdateService 객체
