...
<body>
	...
	<form action="${conPath }/modify.do" method="post" enctype="multipart/form-data">
		...
		<table>
			<tr>
				<th>아이디</th>
				<td><input type="text" name="mid" value="${member.mid }" readonly="readonly" size="6">
				<td rowspan="4"><img src="${conPath }/memberPhotoUp/${member.mphoto }" alt="회원사진"></td>
			</tr>
			<tr>
				<th>현재 비밀번호</th>
				<td><input type="password" name="oldMpw" required="required" size="6"></td>
			</tr>
			<tr>
				<th>변경 비밀번호</th>
				<td><input type="password" name="mpw" size="6"></td>
			</tr>
			<tr>
				<th>이름</th>
				<td><input type="text" name="mname" value="${member.mname }" size="6">
			</tr>
			<tr>
				<th>메일</th>
			...
			<tr>
				<td colspan="3">
					...
					<input type="reset" value="이전화면" onclick="history.back()">
