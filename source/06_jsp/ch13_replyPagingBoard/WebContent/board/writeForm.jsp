...
<body>
	<%
		...
		if(request.getParameter("num")!=null){
			...
			System.out.println("writeForm(답변)에서 넘어온 원글의 ref : " +ref);
			System.out.println("writeForm(답변)에서 넘어온 원글의 re_step : " +re_step);
			System.out.println("writeForm(답변)에서 넘어온 원글의 re_indent : " +re_indent);
		}
	%>
