...
<body>
	<%
		...
		try{
			...
			if(serverFile.exists()){
				...
				os = new FileOutputStream("D:/JU/source/06_jsp/ch14_fileUp/WebContent/fileUpFolder/"+filename); // 소스 폴더로 복사될 파일
				...
				System.out.println("서버에 업로드한 파일을 소스 폴더로 복사 완료하였습니다.");
			}
		}catch(Exception e){
			System.out.println(e.getMessage());
		}finally{
	...
	<% }else{
			out.println("<h2>첨부 안 함 \n 파일 이름 = "+filename+", 오리지널 이름 = "+originalFilename+"</h2>");
	}	%>
