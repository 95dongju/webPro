		...
		<%}else{ 
			for(BookDto book : books){%>
				<tr>
					...
					<td><a href="detail.jsp?bid=<%=book.getBid() %>"><img src="<%=conPath %>/bookImg/<%=book.getBimage1() %>" width="15"></a></td>
					<td><del><%=book.getBprice() %></del> <b><%=book.getBprice()*(100-book.getBdiscount())/100 %>원</b></td>
