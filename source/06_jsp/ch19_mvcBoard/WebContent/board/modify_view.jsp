...
<body>
	<!-- requestScope.modifyBoard, param.bid, param.pageNum (들어와 있는 상태) -->
	<form action="${conPath }/modify.do" method="post">
		<input type="hidden" name="pageNum" value="${param.pageNum }">
		<input type="hidden" name="bid" value="${modifyBoard.bid }"> <!-- or param.bid -->
		<table>
			...
			<tr>
				<td colspan="2">
					...
					<input type="reset" value="취소" onclick="history.go(-1)" class="btn">
