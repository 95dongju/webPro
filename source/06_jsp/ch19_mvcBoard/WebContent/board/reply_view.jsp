...
<body>
	...
	<input type="hidden" name="bindent" value="${replyBoard.bindent }"><!-- 원글 -->
		<table>
			<caption>${param.bid }번 답글쓰기</caption>
			<tr>
				<th>작성자</th><td><input type="text" name="bname" required="required" autofocus="autofocus"></td>
			</tr>
			<tr>
				<th>제목</th><td><input type="text" name="btitle" required="required" value="[답]${replyBoard.btitle }"></td>
			</tr>
			<tr>
